...
public class LikeController {
    ...
    public BaseResponse<String> addLike(UserLoginRequestDto user, @PathVariable Long reviewId) {

        boolean result = false;


        return new BaseResponse(BaseResponseCode.OK.getHttpStatus(), BaseResponseCode.OK.getMessage(), likeService.addLike(user, reviewId));
